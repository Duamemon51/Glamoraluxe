...
.bag .number {
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="{{ url('/') }}">Contact</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Thank You</strong></div>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <h2 class="display-3 text-black">Thank You for Contacting Us!</h2>
            <p class="lead mb-5">Your message has been sent successfully. We'll get back to you shortly.</p>
            <p><a href="{{ url('home') }}" class="btn btn-sm height-auto px-4 py-3 btn-primary">Back to Home</a></p>
          </div>
        </div>
      </div>
    </div>
