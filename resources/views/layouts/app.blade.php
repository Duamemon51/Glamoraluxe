    ...
    text-decoration: none;
        ...
        <nav class="site-navigation text-right text-md-center" role="navigation">
          <ul class="site-menu js-clone-nav d-none d-lg-block">
           ...
           <li class="active"><a href="{{ url('new-arrivals') }}">New Arrivals</a></li>
...
.bag .number {
 ...
 body.offcanvas-menu {
  ...
  position: relative;
   ...
   <div class="site-blocks-cover inner-page w-100" data-aos="fade" style="padding: 80px 0; background-color: #f8f9fa;">
  <div class="row no-gutters align-items-center">
    <div class="col-md-6 ml-auto order-md-2 align-self-start px-5">
    ...
    <div class="col-md-6 order-1 align-self-end px-5">
