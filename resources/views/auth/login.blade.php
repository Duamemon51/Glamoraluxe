...
<div class="container py-5">
    <div class="login-card">
        <div class="login-header">
            <h4><i class="fa-solid fa-user-shield me-2"></i> Login</h4>
        </div>
        <div class="card-body">
...
@endif
            ...
            <form action="{{ route('login') }}" method="POST" id="loginForm">
                ...
                <div class="mb-3">
                    <label class="form-label"><i class="fa fa-envelope me-1 text-danger"></i> Email</label>
                    <input type="email" class="form-control" name="email" required>
                </div>

                <div class="mb-3 position-relative">
                    <label class="form-label"><i class="fa fa-lock me-1 text-danger"></i> Password</label>
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-shopmax" id="loginBtn">
                        <span id="btnText"><i class="fa fa-right-to-bracket me-2"></i> Login</span>
