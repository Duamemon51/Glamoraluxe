...
.bag .number {
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <a href="shop.html">Shop</a> <span class="mx-2 mb-0">/</span> <strong class="text-black"></strong></div>
        </div>
      </div>
    </div>  
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur, vitae, explicabo? Incidunt facere, natus soluta dolores iusto! Molestiae expedita veritatis nesciunt doloremque sint asperiores fuga voluptas, distinctio, aperiam, ratione dolore.</p>
                    <p><strong class="text-primary h4">${{ number_format($product->price, 2) }}</strong></p>
                    <div class="mb-1 d-flex">
                        @php
                            $sizeOptions = $product->size_options ? json_decode($product->size_options) : [];
                        @endphp
    
                        @foreach ($sizeOptions as $size)
                            <label for="option-{{ $size }}" class="d-flex mr-3 mb-3">
                                <span class="d-inline-block mr-2" style="top:-2px; position: relative;">
                                    <input type="radio" id="option-{{ $size }}" name="shop-sizes">
                                </span>
                                <span class="d-inline-block text-black">{{ ucfirst($size) }}</span>
                            </label>
                        @endforeach
                    </div>
                    <div class="mb-5">
